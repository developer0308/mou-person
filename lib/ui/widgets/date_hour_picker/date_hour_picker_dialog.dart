...
import 'package:mou_app/ui/widgets/date_hour_picker/date_hour/date_hour_picker.dart';
import 'package:mou_app/ui/widgets/date_hour_picker/date_hour_picker_dialog_viewmodel.dart';
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            DateHourPicker(
                ...
                this.startDay,
                this.startMonth,
                this.startYear, (hour, minute, day, month, year) {
