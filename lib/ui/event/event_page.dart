...
import 'package:mou_app/ui/event/event_viewmodel.dart';
import 'package:mou_app/ui/event/events_tab/events_tab_view.dart';
import 'package:mou_app/ui/widgets/app_body.dart';
import 'package:mou_app/ui/widgets/app_content.dart';
import 'package:mou_app/ui/widgets/get_box_offset.dart';
      ...
      builder: (context, snapshot) {
        ...
        switch (status) {
          case EventStatus.REQUEST:
            count = eventCount?.forYouToConfirm ?? 0;
            break;
        ...
        children: _displayedStatuses
            .map(
              (e) => EventsTabView(
                key: Key(e.name),
                eventStatus: e,
                onRefreshParent: (eventTypes) => _viewModel.fetchEventCount(eventTypes: eventTypes),
              ),
            )
            .toList(),
      ),
